...
class HomeController extends Controller
{
    public function home(Request $request)
    {
        ...
        $data['categories']['heading'] = __($category->data_values->heading);
        $data['categories']['subheading'] = __($category->data_values->subheading);
        ...
        $data['live_auction']['heading'] = __($liveAuction->data_values->heading);
        $data['live_auction']['subheading'] = __($liveAuction->data_values->subheading);
        ...
        $data['upcoming_auction']['heading'] = __($upcomingAuction->data_values->heading);
        $data['upcoming_auction']['subheading'] = __($upcomingAuction->data_values->subheading);
        ...
        $data['expired_auction']['heading'] = __($expiredAuction->data_values->heading);
        $data['expired_auction']['subheading'] = __($expiredAuction->data_values->subheading);
        ...
        $data['bids']['heading'] = __($bid->data_values->heading);
        $data['bids']['subheading'] = __($bid->data_values->subheading);
        ...
        $data['testimonials']['heading'] = __($testimonial->data_values->heading);
        $data['testimonials']['subheading'] = __($testimonial->data_values->subheading);
        ...
        $data['blogs']['heading'] = __($blog->data_values->heading);
        $data['blogs']['subheading'] = __($blog->data_values->subheading);
        $blogs = getContent('blog.element', false, 3);
        $data['blogs']['lists'] = PostsResource::collection($blogs);

        $faq = getContent('faq.content', true);
        $data['faqs']['heading'] = __($faq->data_values->heading);
        $data['faqs']['subheading'] = __($faq->data_values->subheading);
