...
class ManageUsersController extends Controller
{
    ...
    public function usersWithBalance()
    {
        ...
        $emptyMessage = 'No user found with balance';
    ...
    public function export(Request $request)
    {
        ...
        if ($file_type == 'excel') {
            $data = (new UsersExport($model_type))->download($model_type . ".xlsx");
        } else {
            $data = (new UsersExport($model_type))->download("$model_type.csv", Excel::CSV, ['Content-Type' => 'text/csv']);
        }
