...
<div class="sidebar {{ sidebarVariation()['selector'] }}  {{ @sidebarVariation()['overlay'] }} {{ @sidebarVariation()['opacity'] }}"
            ...
            <ul class="sidebar__menu">
                <li class="sidebar-menu-item {{menuActive('admin.dashboard')}}">
                    <a href="{{route('admin.dashboard')}}" class="nav-link ">
                        <i class="menu-icon las la-home bg--gradi-1"></i>
                        <span class="menu-title">@lang('Dashboard')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.categories')}}">
                    <a href="{{route('admin.categories')}}" class="nav-link ">
                        <i class="menu-icon las la-bars bg--gradi-2"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.product*')}}">
                    <a href="{{route('admin.product.index')}}" class="nav-link ">
                        <i class="menu-icon lab la-product-hunt bg--gradi-3"></i>
                ...
                {{--                                <a href="{{route('admin.product.index')}}" class="nav-link">--}}
                {{--                                    <i class="menu-icon las la-dot-circle bg--gradi-3"></i>--}}
                ...
                <li class="sidebar-menu-item {{menuActive('admin.advertisement.index')}}">
                    <a href="{{route('admin.advertisement.index')}}" class="nav-link ">
                        <i class="menu-icon las la-ad bg--gradi-4"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.gateway*',3)}}">
                        <i class="menu-icon las la-credit-card bg--gradi-7"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.gateway.automatic.index')}} ">
                                <a href="{{route('admin.gateway.automatic.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle bg--gradi-7"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.deposit*',3)}}">
                        <i class="menu-icon las la-credit-card bg--gradi-8"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.deposit.pending')}} ">
                                <a href="{{route('admin.deposit.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle bg--gradi-8"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.withdraw*',3)}}">
                        <i class="menu-icon la la-bank bg--gradi-9"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.method.index')}}">
                                <a href="{{route('admin.withdraw.method.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle bg--gradi-9"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.user.ticket*',3)}}">
                        <i class="menu-icon la la-ticket bg--gradi-10"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.user.ticket')}} ">
                                <a href="{{route('admin.user.ticket')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle bg--gradi-10"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.merchant.ticket*',3)}}">
                        <i class="menu-icon la la-envelope bg--gradi-11"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.merchant.ticket')}} ">
                                <a href="{{route('admin.merchant.ticket')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle bg--gradi-11"></i>
                                    <span class="menu-title">@lang('All Tickets')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.report*',3)}}">
                        <i class="menu-icon la la-list bg--gradi-12"></i>
                ...
                {{--                        <i class="menu-icon las la-life-ring bg--gradi-13"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-images bg--gradi-14"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-store-alt bg--gradi-15"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-cogs bg--gradi-16"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-language bg--gradi-17"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-globe bg--gradi-18"></i>--}}
                ...
                {{--                        <i class="menu-icon la la-html5 bg--gradi-21"></i>--}}
                ...
                {{--                        <i class="menu-icon la la-list bg--gradi-22"></i>--}}
                ...
                {{--                        <i class="menu-icon la la-html5 bg--gradi-23"></i>--}}
                ...
                {{--                                            <i class="menu-icon las la-dot-circle bg--gradi-23"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-cookie-bite bg--gradi-24"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-server bg--gradi-24"></i>--}}
                ...
                {{--                        <i class="menu-icon lab la-css3-alt bg--gradi-25"></i>--}}
                ...
                {{--                        <i class="menu-icon las la-broom bg--gradi-26"></i>--}}
