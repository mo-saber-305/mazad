                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="@lang('Merchant')">
                                    <span class="font-weight-bold">{{ $trx->merchant->fullname }}</span><br>
                                    <span class="small"> <a href="{{ route('admin.merchants.detail', $trx->merchant_id) }}"><span>@</span>{{ $trx->merchant->username }}</a> </span>
...
@push('breadcrumb-plugins')
    ...
    @else
        <form action="{{ route('admin.report.merchant.transaction.search') }}" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append">
                <input type="text" name="search" class="form-control" placeholder="@lang('TRX / Username')" value="{{ $search ?? '' }}">
                <div class="input-group-append">
                    <button class="btn btn--primary" type="submit"><i class="fa fa-search"></i></button>
