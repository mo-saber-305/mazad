...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{ asset('assets/admin/images/1.jpg') }}">
        <div class="form-wrapper">
            ...
            <form action="{{ route('merchant.register') }}" method="POST" class="cmn-form mt-30">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group hover-input-popup">
                    ...
                    <input type="password" id="password" name="password" placeholder="@lang('Create your password')" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" placeholder="@lang('Retype your password')" class="form-control">
                </div>
            ...
            <div class="text-center">
                <span class="text-dark">@lang('Already have an account?')</span> <a href="{{ route('merchant.login') }}">@lang('Login now.')</a>
            </div>
        </div>
    </div><!-- login-area end -->
</div>
