    ...
    <div class="{{ $template == 'frontend' ? 'container pt-120 pb-60':'' }}">
        <div class="ticket__wrapper bg--section">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                ...
                <button class="btn btn-danger close-button" type="button" title="@lang('Close Ticket')" data-bs-toggle="modal" data-bs-target="#DelModal"><i
                        ...
                        <div class="form--group col-sm-12">
                            <div class="d-flex">
                                <div class="left-group col p-0">
                                    ...
                                    <span class="info fs--14">@lang('Allowed File Extensions'): .@lang('jpg'), .@lang('jpeg'), .@lang('png'), .@lang('pdf'),
                                        .@lang('doc'), .@lang('docx')</span>
                                </div>
                                <div class="add-area">
                                    <label class="form--label-2 d-block">&nbsp;</label>
                                    <button class="cmn--btn btn--sm bg--primary ms-2 ms-md-4 form--control-2 addFile" type="button"><i class="las la-plus"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="reply-item bg--section">
                                            <div class="name-area">
                                                <div class="reply-thumb">
                                                    <img src="{{ getImage(imagePath()['profile']['admin']['path'].'/'.$message->admin->image, null, true) }}"
                                                         alt="user">
                                                </div>
                                            ...
                                            <div class="content-area">
                                                ...
                                                @if($message->attachments->count() > 0)
                                                    <div class="mt-2">
                                                        @foreach($message->attachments as $k=> $image)
                                                            <a href="{{route('ticket.download',encrypt($image->id))}}" class="mr-3">
